...
```
@test extractfilename(basename(@__FILE__)) == "Documenter.jl"
------
Output
------
...
<div class='pluto-test call correct pass infix-operator'>
	...
	<p-frames>
	<slotted-code>
<line-like><pre-ish>extractfilename(basename(@__FILE__())) == &quot;Documenter.jl&quot;</pre-ish></line-like>
</slotted-code><slotted-code>
<line-like><pre-ish>extractfilename(basename(</pre-ish>    <pluto-display></pluto-display>
    <script id=qmpzjvlqwsdqewmb>
        ...
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/04a357ae-976f-49f9-85a2-59b2e244eccc/qmpzjvlqwsdqewmb")
	...
	<pre-ish>)) == &quot;Documenter.jl&quot;</pre-ish></line-like>
</slotted-code><slotted-code>
<line-like><pre-ish>extractfilename(</pre-ish>    <pluto-display></pluto-display>
    <script id=ryjaxuiqtkfcwtgu>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/04a357ae-976f-49f9-85a2-59b2e244eccc/ryjaxuiqtkfcwtgu")
        const mime = "text/plain"
...
<line-like>    <pluto-display></pluto-display>
    <script id=tevrvwxzavfytmvh>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/04a357ae-976f-49f9-85a2-59b2e244eccc/tevrvwxzavfytmvh")
        const mime = "text/plain"
...
<line-like>    <pluto-display></pluto-display>
    <script id=wbyonxacnaufhwpy>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/04a357ae-976f-49f9-85a2-59b2e244eccc/wbyonxacnaufhwpy")
        const mime = "text/plain"
	...
	<p-frame-controls>
		...
		<input class="timescrub" style="filter: hue-rotate(149deg) grayscale(.9);" type=range min=1 max='5' value='4'>
	</p-frame-controls>
...
path = "https://github.com/sapal6/Nbdev.jl.git"
res = Dict("github_url" => "https://github.com/sapal6/Nbdev.jl.git")
end
------
Output
------
Any["Dict{String, String}", Any[(("\"github_url\"", MIME type text/plain), ("\"https://github.com/sapal6/Nbdev.jl.git\"", MIME type text/plain))], :Dict, "Dict", "6cf9533a5da67757"]
```
...
<div class='pluto-test call wrong fail infix-operator'>
	<script>
	...
	<p-frames>
	<slotted-code>
<line-like><pre-ish>getsetting(f, &quot;settings&quot;) == res</pre-ish></line-like>
</slotted-code><slotted-code>
<line-like><pre-ish>getsetting(</pre-ish>    <pluto-display></pluto-display>
    <script id=btvanrhcllnbussy>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/c371d5ec-8d89-4f33-8b6d-9add8e15938f/btvanrhcllnbussy")
        const mime = "text/plain"
	...
	<pre-ish>, &quot;settings&quot;) == res</pre-ish></line-like>
</slotted-code><slotted-code>
<line-like>    <pluto-display></pluto-display>
    <script id=dmrqjhegopewxoui>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/c371d5ec-8d89-4f33-8b6d-9add8e15938f/dmrqjhegopewxoui")
	...
	<pre-ish> == res</pre-ish></line-like>
</slotted-code><slotted-code>
<line-like>    <pluto-display></pluto-display>
    <script id=fsujjsfuqidojhib>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/c371d5ec-8d89-4f33-8b6d-9add8e15938f/fsujjsfuqidojhib")
        const mime = "application/vnd.pluto.tree+object"
	...
	<pre-ish> == </pre-ish>    <pluto-display></pluto-display>
    <script id=mvhnykrlbltnnerk>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/c371d5ec-8d89-4f33-8b6d-9add8e15938f/mvhnykrlbltnnerk")
        const mime = "application/vnd.pluto.tree+object"
...
<line-like>    <pluto-display></pluto-display>
    <script id=pkaqkyqqmkyjtkcb>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/c371d5ec-8d89-4f33-8b6d-9add8e15938f/pkaqkyqqmkyjtkcb")
        const mime = "text/plain"
...
<div class='pluto-test call wrong fail infix-operator'>
	...
	<p-frames>
	<slotted-code>
<line-like><pre-ish>getsettings(f, [&quot;settings&quot;, &quot;github_url&quot;]) == res[&quot;github_url&quot;]</pre-ish></line-like>
</slotted-code><slotted-code>
<line-like><pre-ish>getsettings(</pre-ish>    <pluto-display></pluto-display>
    <script id=iceqxukedmwbjmhy>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/c099d54a-38df-46ee-8fb1-37c2b90c1df2/iceqxukedmwbjmhy")
        const mime = "text/plain"
	...
	<pre-ish>, [&quot;settings&quot;, &quot;github_url&quot;]) == res[&quot;github_url&quot;]</pre-ish></line-like>
</slotted-code><slotted-code>
<line-like><pre-ish>getsettings(</pre-ish>    <pluto-display></pluto-display>
    <script id=llmvggmkdouykrzn>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/c099d54a-38df-46ee-8fb1-37c2b90c1df2/llmvggmkdouykrzn")
        const mime = "text/plain"
	...
	<pre-ish>, </pre-ish>    <pluto-display></pluto-display>
    <script id=yryypwcpnolokdbj>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/c099d54a-38df-46ee-8fb1-37c2b90c1df2/yryypwcpnolokdbj")
        const mime = "application/vnd.pluto.tree+object"
	...
	<pre-ish>) == res[&quot;github_url&quot;]</pre-ish></line-like>
</slotted-code><slotted-code>
<line-like>    <pluto-display></pluto-display>
    <script id=htzgrqwblvqdnafx>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/c099d54a-38df-46ee-8fb1-37c2b90c1df2/htzgrqwblvqdnafx")
        const mime = "text/plain"
...
<line-like>    <pluto-display></pluto-display>
    <script id=fmmcuqpwjgjstrvn>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/c099d54a-38df-46ee-8fb1-37c2b90c1df2/fmmcuqpwjgjstrvn")
        const mime = "text/plain"
	...
	<pre-ish> == </pre-ish>    <pluto-display></pluto-display>
    <script id=rstwmtaexadupaax>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/c099d54a-38df-46ee-8fb1-37c2b90c1df2/rstwmtaexadupaax")
        const mime = "text/plain"
...
<line-like>    <pluto-display></pluto-display>
    <script id=xvkvyeodhrxrigyx>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/c099d54a-38df-46ee-8fb1-37c2b90c1df2/xvkvyeodhrxrigyx")
        const mime = "text/plain"
	...
	<p-frame-controls>
		<img src="https://cdn.jsdelivr.net/gh/ionic-team/ionicons@5.5.1/src/svg/time-outline.svg" style="width: 1em; height: 1em; transform: scale(-1,1); opacity: .5; margin-left: 2em;">
		<input class="timescrub" style="filter: hue-rotate(149deg) grayscale(.9);" type=range min=1 max='6' value='5'>
	</p-frame-controls>
...
>       * line–> String which makes up a section
 ...
 [source](https://github-link.vercel.app/api?ghUrl=https://github.com/sapal6/Nbdev.jl/blob/master/src/Documenter.jl&q=Section)
...
Output
------
Any["Section", Any[(:line, ("\"This is a test line\"", MIME type text/plain))], :struct, "Section", "6590607df48e5e63"]
```
...
<line-like><pre-ish>line(</pre-ish>    <pluto-display></pluto-display>
    <script id=ynwcfnzklxuoucrc>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/610d9263-645a-46aa-8f16-12e90787b7bc/ynwcfnzklxuoucrc")
        const mime = "application/vnd.pluto.tree+object"
...
<line-like>    <pluto-display></pluto-display>
    <script id=dusyubvghqatwpph>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/610d9263-645a-46aa-8f16-12e90787b7bc/dusyubvghqatwpph")
        const mime = "text/plain"
...
<line-like>    <pluto-display></pluto-display>
    <script id=pqmmjyxzflumovaw>

        // see https://plutocon2021-demos.netlify.app/fonsp%20%E2%80%94%20javascript%20inside%20pluto to learn about the techniques used in this script
        
        const body = /* See the documentation for PlutoRunner.publish_to_js */ getPublishedObject("72c90840-8f17-11ec-1446-51fbb4d459a7/610d9263-645a-46aa-8f16-12e90787b7bc/pqmmjyxzflumovaw")
        const mime = "text/plain"
...
Output
------
Any["Main.workspace#2.Section", Tuple{Int64, Any}[(1, (Dict{Symbol, Any}(:prefix => "Section", :elements => Any[(:line, ("\"iny, meeny, miny mo\"", MIME type text/plain))], :type => :struct, :prefix_short => "Section", :objectid => "3aa124d32c53f2b"), MIME type application/vnd.pluto.tree+object)), (2, (Dict{Symbol, Any}(:prefix => "Section", :elements => Any[(:line, ("\"🙈 🙊 🙉\"", MIME type text/plain))], :type => :struct, :prefix_short => "Section", :objectid => "ca0ba7f33f886a28"), MIME type application/vnd.pluto.tree+object))], :Array, "", "a528034bf536bd3a"]
```
...
Output
------
Any["Page", Any[(:sections, (Dict{Symbol, Any}(:prefix => "Main.workspace#2.Section", :elements => Tuple{Int64, Any}[(1, (Dict{Symbol, Any}(:prefix => "Section", :elements => Any[(:line, ("\"iny, meeny, miny mo\"", MIME type text/plain))], :type => :struct, :prefix_short => "Section", :objectid => "3aa124d32c53f2b"), MIME type application/vnd.pluto.tree+object)), (2, (Dict{Symbol, Any}(:prefix => "Section", :elements => Any[(:line, ("\"🙈 🙊 🙉\"", MIME type text/plain))], :type => :struct, :prefix_short => "Section", :objectid => "ca0ba7f33f886a28"), MIME type application/vnd.pluto.tree+object))], :type => :Array, :prefix_short => "", :objectid => "a528034bf536bd3a"), MIME type application/vnd.pluto.tree+object)), (:name, ("\"Monkey module\"", MIME type text/plain))], :struct, "Page", "582f3e4618b7666d"]
```
...
Output
------
Any["String", Tuple{Int64, Any}[(1, ("\"i\"", MIME type text/plain)), (2, ("\"j\"", MIME type text/plain))], :Array, "", "ea6161e97a06ca80"]
```
...
Output
------
Any["Mystruct", Any[(:name, ("\"test\"", MIME type text/plain))], :struct, "Mystruct", "d4a2569e7e74a9b2"]
```
